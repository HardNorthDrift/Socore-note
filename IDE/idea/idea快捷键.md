...
​	<!--此命令为idea默认的，自己自定义或者修改了，已修改的为准，如果与其他程序快捷键冲突，也是不能用-->
...
Ctrl+B：快速打开光标处的类或方法（跳到声明定义处，类似Ctrl+鼠标左键）
...
Ctrl+Shift+F： 全局查找	按ESC退出	 （idea）	    （eclipse：Ctrl+H）
...
Alt+F7：查找类或方法在哪被使用、查找当前变量的作用，并列表显示
